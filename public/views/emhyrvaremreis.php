...
<head>
    ...
    <title>Emhyr var Emreis | Wiedmolol</title>
...
<div class="main-container">
    ...
    <section class="content">
        <div class="character-profile">
            <img src="/public/img/emhyrvaremreis.svg" alt="Emhyr var Emreis" class="character-img">
            <div class="character-info">
                <h2>Emhyr var Emreis</h2>
                <p>Emhyr var Emreis, Deithwen Addan yn Carn aep Morvudd (Nilfgaardian language: The White Flame Dancing on the Barrows of his Enemies), also known to a few under his alias as Duny, the Urcheon of Erlenwald (Polish: Jeż z Erlenwaldu) was Emperor of the Nilfgaardian Empire, Lord of Metinna, Ebbing, Gemmera, and Sovereign of Nazair and Vicovaro from 1257 until his death sometime in the late 13th century. He also became the King of Cintra after marrying a false Cirilla in 1268.[2]
